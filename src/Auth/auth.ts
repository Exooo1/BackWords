...
import {AccountType, AuthTokenType, ReqBodyType, status, StatusType} from '../Common/configAccount'
...
auth.post('/auth/registration', async (req: ReqBodyType<{ email: string, password: string, firstName: string, lastName: string }>, res: Response<StatusType<string>>) => {
...
auth.post('/auth/login', async (req: ReqBodyType<{ email: string, password: string }>, res: Response<StatusType<AuthTokenType>>) => {
...
auth.post('/auth/email', (req: ReqBodyType<{ email: string, name: string, verify: string }>, res: Response<StatusType<null>>) => {
...
auth.post('/auth/confirm', async (req: ReqBodyType<{ id: string }>, res: Response<StatusType<null>>) => {
    const {id} = req.body
    try {
